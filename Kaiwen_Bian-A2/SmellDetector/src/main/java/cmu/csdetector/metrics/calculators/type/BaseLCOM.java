...
public abstract class BaseLCOM extends MetricValueCalculator {
    ...
    /*
    getters for child class LCOM2 and LOCM3
     */
    ...
    private Set<IVariableBinding> getVariableInHierarchy() {
        ...
        // for class itself, we should include all attributes(include private attributes)
        ...
        while(type != null) {
            ...
            for(IVariableBinding localVariable: localVariables) {
                // for all super classes, we should exclude all private attributes since they
                // are not accessible by child class
